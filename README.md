# Automated Weather Products: IMD GFS + Skew‑T

This repository automatically generates:

- An animated IMD GFS 850 hPa forecast GIF  
  `imd_gfs_850_hPa_forecast.gif`
...
- It runs `weather_products.py`, which:
  - Downloads IMD GFS 850 hPa forecast images.
  - Fetches upper‑air soundings from Wyoming.
  - Creates an animated GIF and Skew‑T plots.
...
- Animation (raw):
  - `https://raw.githubusercontent.com/<USER>/<REPO>/main/imd_gfs_850_hPa_forecast.gif`
- Skew‑T plots (raw):
